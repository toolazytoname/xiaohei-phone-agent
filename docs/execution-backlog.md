...
| CHAT-005 | BACKLOG | CHAT-004,VOICE-002 | Follow the [free-voice execution plan](free-voice-chat-delivery-plan.md) for separate conversation ASR, one spoken turn, and bounded push-to-talk follow-ups; global stop works and the microphone never auto-opens |
