...
| C — CPU wake word | Optional foreground KWS service | Broad hardware compatibility after microphone permission | Noticeably higher power use; visible foreground service required |
