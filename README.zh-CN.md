...
[English](README.md) · [架构](docs/architecture.zh-CN.md) · [兼容性](docs/compatibility.zh-CN.md) · [DSP 候选设备](docs/dsp-device-candidates.zh-CN.md) · [路线图](docs/roadmap.zh-CN.md) · [安全模型](SECURITY.md)
