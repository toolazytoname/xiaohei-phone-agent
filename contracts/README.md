...
- `opencode-run-budget.v1.schema.json`: closed private time/token/step/output limits for an injected OpenCode adapter; it contains no command, path, credential, or execution grant.
