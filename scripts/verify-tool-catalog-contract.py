...
SCHEMA_FILES = {
    ...
    "xiaohei.tool.input.calendar_test_account.v1": "tool-input-calendar_test_account.v1.schema.json",
    ...
    "xiaohei.tool.output.calendar_test_account.v1": "tool-output-calendar_test_account.v1.schema.json",
}
...
print(
    ...
    f"{len(valid['tools'])} duplicate=reject version=reject missing=reject rollback=reject refs=10"
)
