...
for text, terms in ((core, ("WAITING_FOLLOWUP", "INTERRUPTED", "acknowledgeInterruption")), (adapter, ("void interrupt", "queue_cancelled", "等待后续输入")), (conversation, ("conversation-stop-speech", "speakReply(reply)", "interruptSpeech", "systemTts.destroy")), (test, ("waiting_followup=3", "explicit_resume=1", "illegal_rejected=4"))):
