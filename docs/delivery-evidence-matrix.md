...
| M7 — “Xiaohei Xiaohei” and more devices | partial | Opt-in CPU KWS acoustic end-to-end to gallery, independent DSP control, a clean Android 14 ARM64 generic profile with start/stop/uninstall rollback, a narrowed no-custom-DSP claim, and a reproducible 72-case synthetic probe. | Real multi-speaker/noise/distance and unplugged-power evidence; the synthetic probe exposed substantial positive misses and cannot qualify accuracy. |
